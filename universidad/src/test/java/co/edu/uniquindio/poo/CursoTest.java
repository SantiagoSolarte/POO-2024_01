...
public class CursoTest {
    ...
    @Test
    public void agregarEstudiante2() {
        LOG.info("Inicio agregarEstudiante2");

        var curso = new Curso("Programación I");
        var estudiante = new Estudiante("Camila", "Alzate Rios", "109453264", "camila@uniquindio.edu.co", "315635674",18);

        curso.registrarEstudiante(estudiante);

        assertTrue(curso.getEstudiantes().contains(estudiante));
        LOG.info("Finalizacion agregarEstudiante2");
    }
